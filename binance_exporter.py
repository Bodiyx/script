...
# Конфигурация
PROM_FILE = "/var/lib/node_exporter/textfile_collector/binance.prom"
PING_URL = "https://fapi.binance.com/api/v3/ping"
INTERVAL = 3
WINDOW_HOURS = 3600
WINDOW_MIN = 60
...
while True:
    ...
    try:
        with open(PROM_FILE, "w") as f:
            f.write(f"binance_latency_ms {latency_ms}\n")
            f.write(f"binance_api_status {status}\n")
            f.write(f"binance_latency_max_1h_ms {max_latency_1h}\n")
            f.write(f"binance_latency_avg_60s_ms {avg_latency_60s}\n")
    except:
        pass
