...
# Конфигурация
PROM_FILE = "/var/lib/node_exporter/textfile_collector/okx.prom"
...
while True:
    ...
    try:
        with open(PROM_FILE, "w") as f:
            f.write(f"okx_latency_ms {latency_ms}\n")
            f.write(f"okx_api_status {status}\n")
            f.write(f"okx_latency_max_1h_ms {max_latency_1h}\n")
            f.write(f"okx_latency_avg_60s_ms {avg_latency_60s}\n")
    except:
        pass
